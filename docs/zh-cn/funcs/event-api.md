...
* 模拟按键,例如home back等
* @param key 对应的值分别为 home, back, left, right, up, down, center, menu, search, enter, delete(or del), recent(recent apps)
...
* @return {null|布尔型}
  ...
  var result = agentEvent.enter(); if (result){ toast("成功"); }else { toast("失败"); } } main();
